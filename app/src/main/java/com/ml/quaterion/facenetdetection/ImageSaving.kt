...
class ImageSaving : AppCompatActivity() {

    private val REQUEST_CODE_PERMISSIONS
            = 10
    private val REQUIRED_PERMISSIONS = arrayOf(Manifest.permission.CAMERA , Manifest.permission.WRITE_EXTERNAL_STORAGE )
    private lateinit var cameraTextureView : TextureView
    private lateinit var faceDetection : com.ml.quaterion.facenetdetection.FaceDetection
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.saving_image)
        ...
        faceDetection = com.ml.quaterion.facenetdetection.FaceDetection( this , boundingBoxOverlay)
        ...
        val captureButton = findViewById<Button>(R.id.button6);
        captureButton.setOnClickListener {
            val bitmap = cameraTextureView.bitmap
            faceDetection.saveBitmap(cameraTextureView.bitmap,"Jueun");
        }
    ...
    private fun startCamera( cameraFacing : CameraX.LensFacing ) {
        ...
        val analyzerUseCase = ImageAnalysis(analyzerConfig).apply {
            setAnalyzer( Executors.newSingleThreadExecutor() , faceDetection )
        }
